    ...
    <body className="mx-auto flex flex-col p-2 bg-black">
        ...
        <div  className='mx-auto max-w-md' >
            ...
            <form action="">
                ...
                <input className="block w-full border border-grey py-2 uppercase text-grey mb-10" placeholder="&gt; pixel_ " name="ussername" type="text" />
                ...
                <label className='uppercase text-grey font-display  ' htmlFor="password">&gt; Repeat password:</label>
                <input className="block w-full border border-grey py-2 uppercase text-grey " placeholder="&gt; enter secure pass" name="password" type="text" />
            ...
            <div className="flex gap-5">
                ...
                <p className='text-violet uppercase'>Already have an account? Log in &gt; </p>
            </div>
